export const queryKeys = {
  ...
  activity: (params: { page?: number; q?: string }) => ["activity", params] as const,
  settings: ["settings"] as const,
  profile: ["profile"] as const,
  reports: ["reports"] as const,
  stockIn: (params: { page?: number; q?: string }) => ["stock-in", params] as const,
  ...
  openMrfs: (params: { page?: number; q?: string } = {}) => ["mrf-open", params] as const,
  adjustments: (params: { page?: number; q?: string }) => ["adjustments", params] as const,
  notifications: ["notifications"] as const,
  myPermissions: ["me-permissions"] as const,
  purchaseOrders: (params: { page?: number; q?: string }) => ["purchase-orders", params] as const,
  purchaseRequests: (params: { page?: number; q?: string }) => ["purchase-requests", params] as const,
};
